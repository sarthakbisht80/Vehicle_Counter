...
min_width_react=80 #min width
min_hight_react=80 #min hieght
count_line_position= 550
#Initialize Substuctor
...
while True:
   ...
   for (i,c) in enumerate(counterSahpe):
       ...
       cv2.putText(frame1,"Gaddi :"+str(counter),(x, y-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,254,0),2)
